  ...
  return(
    <div className={"row"}>
      <div className={"col-sm-6 mx-auto"}>
        <Profile userId={"test1"} userName={"테스터1"} userTel={"123-123-123"} userEmail={"eee@naver.com"}/>
        <Profile userId={"test2"} userName={"테스터2"} userTel={"321-321-321"} userEmail={"aaa@naver.com"}/>
      </div>
    </div>
  );
}
